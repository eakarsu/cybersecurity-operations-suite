...
const adminCookie = await login('admin@cybersecurity.local', 'admin123');
const managerCookie = await login('manager@cybersecurity.local', 'manager123');
const analystCookie = await login('analyst@cybersecurity.local', 'analyst123');
