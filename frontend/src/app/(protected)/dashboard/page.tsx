...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Cybersecurity Operations Dashboard"
      subtitle="One merged cybersecurity operations view for Incidents, Alerts, Assets, Vulnerabilities, Investigations, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared cybersecurity operations jobs into one surface. Incidents, Alerts, Assets, Vulnerabilities, Investigations, Playbooks, documents, audit, and AI are presented as platform features.</div>
