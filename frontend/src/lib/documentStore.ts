...
const seed: DocumentRecord[] = [
  { id: 'doc-1', name: 'Incidents Packet', type: 'Incidents', owner: 'Security Lead', status: 'In review', updatedAt: '2026-05-24 10:00' },
  { id: 'doc-2', name: 'Alerts Review Bundle', type: 'Alerts', owner: 'Operations Lead', status: 'Approval pending', updatedAt: '2026-05-24 11:20' },
  { id: 'doc-3', name: 'Assets Evidence Set', type: 'Assets', owner: 'Governance Lead', status: 'Ready', updatedAt: '2026-05-24 09:35' },
];
