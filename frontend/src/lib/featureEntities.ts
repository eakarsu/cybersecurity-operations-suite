...
const entitySeeds = [
  ...
  ["pentest-scope","Pentest Scope Records","Pentest Scope operating queue","Open","Pentest Scope follow-up list","Penetration Testing Agent","$0"],
  ["vulnerability-findings","Vulnerability Findings Records","Vulnerability Findings operating queue","Review","Vulnerability Findings follow-up list","Penetration Testing Agent","$0"],
  ["attack-path-review","Attack Path Review Records","Attack Path Review operating queue","Review","Attack Path Review follow-up list","Penetration Testing Agent","$0"],
