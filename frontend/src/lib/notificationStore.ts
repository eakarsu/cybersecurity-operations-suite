...
const seed: NotificationItem[] = [
  ...
  { id: 'note-2', title: 'Alerts approval due', detail: 'Alerts exception list needs approval.', read: false },
  { id: 'note-3', title: 'Assets updated', detail: 'Assets operating queue was refreshed.', read: true },
];
