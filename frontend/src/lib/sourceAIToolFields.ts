...
export const sourceAIToolFieldsByToolId: Record<string, SourceAIToolField[]> = {
  "penetration-testing-agent-copilot": [
    {
      "name": "objective",
      "label": "Objective",
      "type": "textarea",
      "defaultValue": "Improve the Penetration Testing Agent workflow and produce audit-ready next actions.",
      "placeholder": "Describe the goal",
      "options": [],
      "required": true,
      "source": "AIAutonomousPenTestingAgent"
    },
    {
      "name": "source_context",
      "label": "Source Context",
      "type": "textarea",
      "defaultValue": "Paste Penetration Testing Agent source details, notes, records, or documents.",
