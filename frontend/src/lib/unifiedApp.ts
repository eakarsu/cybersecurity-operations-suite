...
const features = [
  ...
  },
  {
    ...
    icon: Workflow,
    summary: "Assets, rules of engagement, authorization, and test boundaries.",
    bullets: ["Pentest Scope queue","AI assisted review","Audit trail"],
    metrics: [
      { label: "Pentest Scope", value: "28", note: 'Active' },
      { label: 'Review', value: "5", note: 'Needs attention' },
      { label: 'Due Soon', value: "3", note: 'Next 14 days' },
    ],
  },
  {
    slug: "vulnerability-findings",
    title: "Vulnerability Findings",
    href: "/vulnerability-findings",
    category: "Penetration Testing Agent",
    icon: Workflow,
    summary: "Findings, severity, evidence, exploitability, and remediation notes.",
    bullets: ["Vulnerability Findings queue","AI assisted review","Audit trail"],
    metrics: [
      { label: "Vulnerability Findings", value: "39", note: 'Active' },
      { label: 'Review', value: "6", note: 'Needs attention' },
      { label: 'Due Soon', value: "4", note: 'Next 14 days' },
    ],
  },
  {
    slug: "attack-path-review",
    title: "Attack Path Review",
    href: "/attack-path-review",
    category: "Penetration Testing Agent",
    icon: Workflow,
    summary: "Attack paths, controls, likely impact, and prioritized fixes.",
    bullets: ["Attack Path Review queue","AI assisted review","Audit trail"],
    metrics: [
      { label: "Attack Path Review", value: "50", note: 'Active' },
...
export const featureFamilies = [
  ...
  { name: 'Penetration Testing Agent', features: ["Pentest Scope","Vulnerability Findings","Attack Path Review"] },
