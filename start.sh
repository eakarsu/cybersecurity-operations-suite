...
PORT="${PORT:-4200}"
DB_NAME="${PGDATABASE:-cybersecurity_operations_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Cybersecurity Operations Suite"
echo "======================================="
echo
...
echo "Starting cybersecurity operations suite frontend on http://localhost:$PORT"
echo "Login: admin@cybersecurity.local / admin123"
